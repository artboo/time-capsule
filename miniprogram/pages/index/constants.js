...
const QuickStartPoints = [
  { id: '1', title: '时间胶囊：封存今日，启于未来', text:'在岁月的长河中，我们轻手轻脚，将一段段时光轻轻折叠，放入一个神秘的容器。这不仅是一个简单的收藏行为，而是一次神圣的仪式，一次与时间的对话，一次对未来的深情寄托。' },
  { id: '2', title: '仪式的开始：选择与封存', text:'在庄重的仪式中，我们将这些珍贵的记忆一一放入时间胶囊。伴随着低沉的钟声和悠扬的颂歌，我们用密封蜡和金属盖将胶囊封闭，确保它能够抵御时间的侵蚀，穿越无数个春秋。' },
  { id: '3', title: '埋藏之地：历史的见证', text:'选择一个充满意义的地点，或许是一片古老的森林，或许是一座城市的心脏。在这片土地上，时间胶囊将静静地沉睡，与大地同呼吸，与星辰共流转。它将成为历史的见证者，见证时代的变迁和人类的发展。' },
  { id: '4', title: '未来的召唤：开启与启示', text:'在未来的某一天，或许是几十年，几个世纪，当时间胶囊被重新打开，那将是一次跨越时空的对话。未来的人们将通过这些物品，感受到我们这个时代的气息，理解我们的思想和情感，体会到我们对未来的憧憬和期待。即使时间流逝，有些东西是永恒的——那就是我们对美好未来的不懈追求和无限想象。' },
];
